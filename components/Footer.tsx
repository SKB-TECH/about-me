...
const Footer =()=> {
    return (
        <section className={'min-w-full h-40 flex flex-col '}>
            <hr className={'text-blues'}></hr>
            <div className={'flex flex-row lg:ml-10 gap-5 mt-10 mb-10'}>
            ...
            <div className={'flex flex-col items-center justify-center mt-5'}>
                <p className={'font-primaryr text-blues text-sm '}>All rights reserved by Shako Kinyamba Benjamin SKB-TECH</p>
            </div>
        </section>
    );
};
